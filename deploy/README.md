...
## 二次部署
- `git pull`
- 如后端有变更：`docker compose -f deploy/docker-compose.yml up -d --build`
...
## 只更新后端
- `docker compose -f deploy/docker-compose.yml build bbq-server`
- `docker compose -f deploy/docker-compose.yml up -d bbq-server`
